...
For your APIs to be useful, it will very likely need to integrate with the API server so that it can look for and update the K8S resources.  This is because you will likely be creating deployments, pods, etc based on the semantics of your custom resource.  In order to help you with this, there is the [apiserver-builder](https://github.com/kubernetes-incubator/apiserver-builder/blob/master/README.md) incubator project that provide scaffolding to create your APIs. 
